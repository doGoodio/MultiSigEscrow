...
contract MultiSigWalletWithDailyLimitFactory is Factory {
  ...
  function create(address[] _owners, uint _required, bool _fixed_owners, uint _dailyLimit)
        public
        returns (address wallet)
    {
      wallet = new MultiSigWalletWithDailyLimit(_owners, _required, _fixed_owners, _dailyLimit);
        register(wallet);
    }
}
